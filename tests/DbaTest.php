...
test('firstKey() - retrieves the first key on an existing store - should return TRUE', function () {
    $this->dbaObject->open();
    expect($this->dbaObject->firstKey())->toEqual('123');
});
...
test('nextKey() - retrieving the next key on an existing store - should return TRUE', function () {
    $this->dbaObject->open();
    $this->dbaObject->insert('1', 'hello world, this is 7PHP');
    $this->dbaObject->insert('2', 'hello world, this is 7PHP - pass 02');
    $who_cares_about_the_result = $this->dbaObject->firstKey();
    expect($this->dbaObject->nextKey())->toEqual(2);
});
